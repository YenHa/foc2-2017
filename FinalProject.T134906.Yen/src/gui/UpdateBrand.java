...
public class UpdateBrand extends JFrame implements ActionListener {
	...
	public UpdateBrand(int bid) {
		...
		Brand c = braDA.getBrand(brandID);
		txtName.setText(c.getName());
		txtDescription.setText(c.getBrandDescription());
	...
	private void updateBrand() {
		String brandName = txtName.getText();
		String brandDescription = txtDescription.getText();
		
		braDA.update(brandName, brandDescription, brandID);
	}
}
