...
public class AddProduct extends JFrame implements ActionListener {
	...
	private void initGUI() {
		setResizable(false);
		setTitle("Add Product - Yen Ha");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 362, 354);
		...
		txtName.setBounds(147, 99, 186, 20);
		...
		btnAdd.setBounds(63, 272, 89, 23);
		contentPane.add(btnAdd);
		btnAdd.addActionListener(this);
		
		btnCancel = new JButton("Cancel");
		btnCancel.setBounds(196, 272, 89, 23);
		...
		cmbCategory.setBounds(147, 130, 186, 20);
		contentPane.add(cmbCategory);
		
		JLabel lblUnitOfMeasre = new JLabel("Unit of Measure");
		lblUnitOfMeasre.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		cmbUnit.setBounds(147, 161, 186, 20);
		...
		cmbBrand.setBounds(147, 188, 186, 20);
